...
#define CONFIGURATION "--host-cc=arm-none-linux-gnueabi-gcc --cc=arm-none-linux-gnueabi-gcc --target=arm-linux --enable-fbdev --disable-dvdread --disable-live --disable-mp3lib --enable-mad --disable-win32dll --disable-mencoder --disable-ivtv --disable-dvdnav --disable-dvdread-internal --disable-libdvdcss-internal --enable-libavcodec_a --prefix=./install"

#define MPLAYER_DATADIR "./install/share/mplayer"
#define MPLAYER_CONFDIR "./install/etc/mplayer"
#define MPLAYER_LIBDIR "./install/lib"
...
#undef CONFIG_XMMS
#define BINARY_CODECS_PATH "./install/lib/codecs"
