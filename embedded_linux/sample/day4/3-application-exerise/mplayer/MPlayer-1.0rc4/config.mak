...
CONFIGURATION = --host-cc=arm-none-linux-gnueabi-gcc --cc=arm-none-linux-gnueabi-gcc --target=arm-linux --enable-fbdev --disable-dvdread --disable-live --disable-mp3lib --enable-mad --disable-win32dll --disable-mencoder --disable-ivtv --disable-dvdnav --disable-dvdread-internal --disable-libdvdcss-internal --enable-libavcodec_a --prefix=./install
...
BINDIR  = $(DESTDIR)./install/bin
DATADIR = $(DESTDIR)./install/share/mplayer
LIBDIR  = $(DESTDIR)./install/lib
MANDIR  = $(DESTDIR)./install/share/man
CONFDIR = $(DESTDIR)./install/etc/mplayer

AR      = arm-none-linux-gnueabi-ar
AS      = arm-none-linux-gnueabi-gcc
CC      = arm-none-linux-gnueabi-gcc
CXX     = arm-none-linux-gnueabi-gcc
HOST_CC = arm-none-linux-gnueabi-gcc
INSTALL = install
INSTALLSTRIP =
WINDRES = windres

CFLAGS   = -Wstrict-prototypes -Wmissing-prototypes -Wundef -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Wall -Wno-switch -Wpointer-arith -Wredundant-decls -O4   -pipe -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -I.  -D_REENTRANT 
ASFLAGS  = $(CFLAGS)
...
EXTRALIBS          = -Wl,-z,noexecstack  -ffast-math   -lncurses -lpng -lz -ljpeg -lasound -ldl -lpthread -lz -lmad -lpthread -ldl -rdynamic  -lm 
EXTRALIBS_MPLAYER  = 
EXTRALIBS_MENCODER = 
